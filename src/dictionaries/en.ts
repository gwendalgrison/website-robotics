export const en = {
    ...
    events: {
        title: 'Events',
        intro: 'Discover our upcoming events and past activities in robotics.',
        upcoming: {
    ...
    contact: {
        title: 'Contact Us',
        intro: 'Have questions or want to join us? Get in touch with our team.',
        form: {
            name: 'Your Name',
            email: 'Your Email',
            message: 'Message',
    ...
    benefits: [
        {
            ...
            description: "Work on real robotics projects and gain practical skills",
            icon: "🔧"
        },
        {
            title: "Industry Connections",
            description: "Network with leading companies in robotics and automation",
            icon: "🤝"
        },
        {
            title: "Innovation",
            description: "Access to state-of-the-art equipment and technologies",
            icon: "💡"
        }
    ]
} 
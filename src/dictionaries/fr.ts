export const fr = {
    ...
    events: {
        title: 'Événements',
        intro: 'Découvrez nos prochains événements et activités passées en robotique.',
        upcoming: {
    ...
    contact: {
        title: 'Contactez-nous',
        intro: 'Des questions ou envie de nous rejoindre ? Contactez notre équipe.',
        form: {
            name: 'Votre Nom',
            email: 'Votre Email',
            message: 'Message',
        ...
        email: 'telecomrobotic@gmail.com',
        location: 'Telecom Paris, 19 Place Marguerite Perey, 91120 Palaiseau',
    },
    cta: {
        title: "Prêt à Commencer Votre Aventure en Robotique ?",
    ...
    benefits: [
        {
            ...
            description: "Travaillez sur des projets réels et acquérez des compétences pratiques",
            icon: "🔧"
        },
        {
            title: "Connexions Industrielles",
            description: "Réseautez avec des entreprises leaders en robotique et automatisation",
            icon: "🤝"
        },
        {
            title: "Innovation",
            description: "Accès à des équipements et technologies de pointe",
            icon: "💡"
        }
    ]
} 